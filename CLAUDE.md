...
Test classes follow the pattern: unit tests for parsers and helpers (no mock needed) + integration tests using `@respx.mock` + `monkeypatch.setenv("DATA_GO_KR_API_KEY", "test-key")` fixture.
